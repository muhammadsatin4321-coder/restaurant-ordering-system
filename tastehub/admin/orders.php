...
<head>
    ...
    <style>
        ...
        .nav-link-item:hover, .nav-link-item.active { color: #fff; background: var(--primary-gradient); box-shadow: 0 10px 25px var(--glow-color); }
        ...
        .table > :not(caption) > * > * { padding: 1.1rem 1.25rem; }
        .table thead th { font-size: 0.72rem; text-transform: uppercase; letter-spacing: 1px; font-weight: 800; color: #6c757d; background: #fafbfc; border-bottom: 1px solid var(--border-light); }
        .status-pill { font-size: 0.75rem; font-weight: 700; padding: 6px 14px; border-radius: 30px; display: inline-flex; align-items: center; gap: 6px; }
...
<aside class="admin-sidebar p-3">
    <div class="d-flex align-items-center mb-4 px-2 pt-2">
        ...
        <span class="fw-bold fs-5 text-white"><?= e($settings['restaurant_name'] ?? 'Bistro Admin') ?></span>
    </div>
