...
<head>
    ...
    <style>
        ...
        .food-thumb { width: 55px; height: 55px; border-radius: 14px; object-fit: cover; }
...
<aside class="admin-sidebar p-3">
    ...
    <nav class="nav flex-column">
        ...
        <a href="menu.php" class="nav-link-item active"><i class="bi bi-egg-fried"></i> Food Items</a>
                        ...
                        <?php if (!empty($foods)): ?>
                            <?php foreach ($foods as $food): ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form method="POST" action="menu.php" onsubmit="return confirm('Are you sure you want to delete this item?');" class="d-inline">
